...
+ (instancetype)sharedClient{
    ...
    dispatch_once(&onceToken, ^{
        ...
        _sharedClient.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json",@"text/html",@"application/x-javascript",@"text/javascript",@"text/plain", nil];
